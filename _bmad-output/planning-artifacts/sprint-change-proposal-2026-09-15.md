...
| Read architecture spine (`architecture-Archon-2026-09-12`)                         | Fix the Consistency-Conventions logging row to match AD-3.                                                                                                          |
...
**A1 · read-spine logging contradicts AD-3** · `architecture-Archon-2026-09-12/ARCHITECTURE-SPINE.md` Consistency Conventions → Logging row
