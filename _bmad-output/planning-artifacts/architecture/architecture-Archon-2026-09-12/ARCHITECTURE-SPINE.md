...
binds:
  ...
  - 'architecture-Archon-2026-09-05 HITL AD-3'
  - 'architecture-Archon-2026-09-05 HITL AD-4'
sources:
  ...
  - ../../../specs/spec-readable-agent-transcript/test-plan.md
  - ../architecture-Archon-2026-09-05/ARCHITECTURE-SPINE.md
companions:
...
From `architecture-Archon-2026-09-05` (HITL spine, feature altitude). Read-only; original IDs kept. Its numbering overlaps this spine's, so a parent decision is always written **`HITL AD-n`**; a bare `AD-n` is always local.
