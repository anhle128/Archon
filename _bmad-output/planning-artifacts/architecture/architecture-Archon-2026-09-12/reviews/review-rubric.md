...
Reviewed: `_bmad-output/planning-artifacts/architecture/architecture-Archon-2026-09-12/ARCHITECTURE-SPINE.md`
...
(`ux-Archon-2026-09-09/EXPERIENCE.md`, Occurrence grouping). Deriving `Run N` vs `Iteration N` from
