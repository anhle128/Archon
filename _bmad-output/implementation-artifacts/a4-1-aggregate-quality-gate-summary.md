...
- [ ] [Review][Patch] R3-F1 — The R2-F2 fix leaves story and review-finding identifiers in a workflow test artifact, violating the project rule that code and test artifacts must not contain plan, story, epic, or finding identifiers [packages/workflows/src/defaults/v2-tr-join-contract.test.ts:306].
