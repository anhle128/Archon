...
```bash
.agents/skills/verify-archon/bin/verify-archon launch
...
.agents/skills/verify-archon/bin/verify-archon doctor
```
...
```bash
.agents/skills/verify-archon/bin/verify-archon cli -- doctor
```
...
Root: `.agents/skills/verify-archon/evidence/runs/<run-id>/` (named in `verify-archon evidence --json`). Cleanup must not delete this tree.
...
```bash
.agents/skills/verify-archon/bin/verify-archon cleanup
.agents/skills/verify-archon/bin/verify-archon cleanup --dry-run   # print, do not kill
```
...
Executable: `.agents/skills/verify-archon/bin/verify-archon`
