...
assistants:
  ...
  codex:
    model: gpt-5.6-sol
    modelReasoningEffort: medium  # Legacy provider default; raw non-empty string    webSearchMode: live  # 'disabled' | 'cached' | 'live'
