...
- At least one AI assistant installed and configured (Claude Code, Codex, or Grok — Archon orchestrates them, it does not bundle them)
...
cp .env.example .env
nano .env  # Add your AI assistant tokens (Claude, Codex, Grok, or Pi)
