/**
 * Deterministic per-room data selectors. Never throw on malformed event payloads.
 */
...
import { getPlannotatorReviewUrl, readApprovalContext } from './read-approval-context';
...
function eventsForRow(events: readonly WorkflowEvent[], row: LogRow): WorkflowEvent[] {
...
function lastTerminal(events: readonly WorkflowEvent[]): WorkflowEvent | null {
