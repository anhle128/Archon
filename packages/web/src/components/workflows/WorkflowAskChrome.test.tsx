...
import { WorkflowAskChrome, type WorkflowAskChromeProps } from './WorkflowAskChrome';
...
function renderChrome(overrides: Partial<WorkflowAskChromeProps> = {}): React.ReactElement | null {
  return WorkflowAskChrome({
    status: 'paused',
    pendingInteractions: [
      interaction(),
